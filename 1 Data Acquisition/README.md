...
# Competencies
- $`\textcolor{blue}{\text{The ability to analyze data for its dimensionality, the quality of the data, and the limitations of the data.}}`$
- $`\textcolor{blue}{\text{Develop the ability to create data models that accurately represents the data found within a dataset.}}`$
- $`\textcolor{blue}{\text{The ability to use SQL (PostgreSQL) to manipulate, create, and update the data within the database.  This is accomplished through the proper use of the correct queries.}}`$

# Assessment Objectives
- $`\textcolor{blue}{\text{To develop a research question that can be answered with the given datasets.  Two datasets will be used in the assessment.  One is given and the other is an add-on dataset.  This question is stated in the PDF that is found in this repository}}`$.
- $`\textcolor{blue}{\text{Creation of an entity relationship diagram (ERD).  This diagram can be found in the written document.}}`$
- $`\textcolor{blue}{\text{Create the appropriate code for creating a table for the add-on dataset as well as the appropriate code to create the add-on table in the database.}}`$

# Technologies and Concepts Used
The concepts and technologies used to create and complete the assessment are the following:
- $`\textcolor{blue}{\text{Use of SQL to create the appropriate queries.}}`$
- $`\textcolor{blue}{\text{The ability to navigate PGAdmin 4 to create queries and view the tables within the database.}}`$
- $`\textcolor{blue}{\text{The ability to load a CSV file into a table using the appropriate commands.}}`$
